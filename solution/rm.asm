 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 04 0a 00 00 	movzbl 0xa04(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 ac 09 00 00 	jmp    *0x9ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba a5 09 00 00       	mov    $0x9a5,%edx
        while(*s != 0){
...
vfree(void *ap)
{
 ...
 5f1:	a1 38 0d 00 00       	mov    0xd38,%eax
{
 ...
 5fb:	8b 5d 08             	mov    0x8(%ebp),%ebx
    bp = (Header*)ap - 1;
 5fe:	8d 53 f8             	lea    -0x8(%ebx),%edx
  if (((uint) ap) >= ((uint) HUGE_PAGE_START)) {
 601:	81 fb ff ff ff 1d    	cmp    $0x1dffffff,%ebx
 607:	76 4f                	jbe    658 <vfree+0x68>
  {
    // free huge pages
    Header *bp, *p;
 ...
 609:	a1 2c 0d 00 00       	mov    0xd2c,%eax
 60e:	66 90                	xchg   %ax,%ax
 610:	89 c1                	mov    %eax,%ecx
 612:	8b 00                	mov    (%eax),%eax
 614:	39 d1                	cmp    %edx,%ecx
 616:	73 78                	jae    690 <vfree+0xa0>
 618:	39 d0                	cmp    %edx,%eax
 61a:	77 04                	ja     620 <vfree+0x30>
      if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 61c:	39 c1                	cmp    %eax,%ecx
 61e:	72 f0                	jb     610 <vfree+0x20>
        break;
    if(bp + bp->s.size == p->s.ptr){
 620:	8b 73 fc             	mov    -0x4(%ebx),%esi
 623:	8d 3c f2             	lea    (%edx,%esi,8),%edi
 626:	39 f8                	cmp    %edi,%eax
 628:	0f 84 c2 00 00 00    	je     6f0 <vfree+0x100>
      bp->s.size += p->s.ptr->s.size;
      bp->s.ptr = p->s.ptr->s.ptr;
 62e:	89 43 f8             	mov    %eax,-0x8(%ebx)
    } else
      bp->s.ptr = p->s.ptr;
    if(p + p->s.size == bp){
 631:	8b 41 04             	mov    0x4(%ecx),%eax
 634:	8d 34 c1             	lea    (%ecx,%eax,8),%esi
 637:	39 f2                	cmp    %esi,%edx
 639:	74 75                	je     6b0 <vfree+0xc0>
      p->s.size += bp->s.size;
      p->s.ptr = bp->s.ptr;
 63b:	89 11                	mov    %edx,(%ecx)
      ...
      p->s.ptr = bp;
    hugefreep = p;
 63d:	89 0d 2c 0d 00 00    	mov    %ecx,0xd2c
  }
}
 643:	5b                   	pop    %ebx
 644:	5e                   	pop    %esi
 ...
 652:	72 04                	jb     658 <vfree+0x68>
 654:	39 d0                	cmp    %edx,%eax
 656:	77 10                	ja     668 <vfree+0x78>
    for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr){
 658:	89 c1                	mov    %eax,%ecx
 65a:	8b 00                	mov    (%eax),%eax
 65c:	39 d1                	cmp    %edx,%ecx
 65e:	73 f0                	jae    650 <vfree+0x60>
 660:	39 d0                	cmp    %edx,%eax
 662:	77 04                	ja     668 <vfree+0x78>
      if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 664:	39 c1                	cmp    %eax,%ecx
 666:	72 f0                	jb     658 <vfree+0x68>
    if(bp + bp->s.size == p->s.ptr){
 668:	8b 73 fc             	mov    -0x4(%ebx),%esi
 66b:	8d 3c f2             	lea    (%edx,%esi,8),%edi
 66e:	39 f8                	cmp    %edi,%eax
 670:	74 56                	je     6c8 <vfree+0xd8>
      bp->s.ptr = p->s.ptr->s.ptr;
 672:	89 43 f8             	mov    %eax,-0x8(%ebx)
    if(p + p->s.size == bp){
 675:	8b 41 04             	mov    0x4(%ecx),%eax
 678:	8d 34 c1             	lea    (%ecx,%eax,8),%esi
 67b:	39 f2                	cmp    %esi,%edx
 67d:	74 60                	je     6df <vfree+0xef>
      p->s.ptr = bp->s.ptr;
 67f:	89 11                	mov    %edx,(%ecx)
}
 681:	5b                   	pop    %ebx
    freep = p;
 682:	89 0d 38 0d 00 00    	mov    %ecx,0xd38
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 692:	0f 82 78 ff ff ff    	jb     610 <vfree+0x20>
 698:	39 d0                	cmp    %edx,%eax
 69a:	0f 86 70 ff ff ff    	jbe    610 <vfree+0x20>
    if(bp + bp->s.size == p->s.ptr){
 6a0:	8b 73 fc             	mov    -0x4(%ebx),%esi
 6a3:	8d 3c f2             	lea    (%edx,%esi,8),%edi
 6a6:	39 f8                	cmp    %edi,%eax
 6a8:	75 84                	jne    62e <vfree+0x3e>
 6aa:	eb 44                	jmp    6f0 <vfree+0x100>
 6ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      p->s.size += bp->s.size;
 6b0:	03 43 fc             	add    -0x4(%ebx),%eax
    hugefreep = p;
 6b3:	89 0d 2c 0d 00 00    	mov    %ecx,0xd2c
      p->s.size += bp->s.size;
 6b9:	89 41 04             	mov    %eax,0x4(%ecx)
      p->s.ptr = bp->s.ptr;
 6bc:	8b 53 f8             	mov    -0x8(%ebx),%edx
 6bf:	89 11                	mov    %edx,(%ecx)
    hugefreep = p;
 6c1:	eb 80                	jmp    643 <vfree+0x53>
 6c3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 6c7:	90                   	nop
      bp->s.size += p->s.ptr->s.size;
 6c8:	03 70 04             	add    0x4(%eax),%esi
 ...
 6d8:	8d 34 c1             	lea    (%ecx,%eax,8),%esi
 6db:	39 f2                	cmp    %esi,%edx
 6dd:	75 a0                	jne    67f <vfree+0x8f>
      p->s.size += bp->s.size;
 6df:	03 43 fc             	add    -0x4(%ebx),%eax
 6e2:	89 41 04             	mov    %eax,0x4(%ecx)
      p->s.ptr = bp->s.ptr;
 6e5:	8b 53 f8             	mov    -0x8(%ebx),%edx
 6e8:	eb 95                	jmp    67f <vfree+0x8f>
 6ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      bp->s.size += p->s.ptr->s.size;
 6f0:	03 70 04             	add    0x4(%eax),%esi
 6f3:	89 73 fc             	mov    %esi,-0x4(%ebx)
      bp->s.ptr = p->s.ptr->s.ptr;
 6f6:	8b 01                	mov    (%ecx),%eax
 6f8:	8b 00                	mov    (%eax),%eax
 6fa:	89 43 f8             	mov    %eax,-0x8(%ebx)
    if(p + p->s.size == bp){
 6fd:	8b 41 04             	mov    0x4(%ecx),%eax
 700:	8d 34 c1             	lea    (%ecx,%eax,8),%esi
 703:	39 f2                	cmp    %esi,%edx
 705:	0f 85 30 ff ff ff    	jne    63b <vfree+0x4b>
 70b:	eb a3                	jmp    6b0 <vfree+0xc0>
 70d:	8d 76 00             	lea    0x0(%esi),%esi

00000710 <free>:
 vfree(ap);
 710:	e9 db fe ff ff       	jmp    5f0 <vfree>
 ...
 729:	8b 45 0c             	mov    0xc(%ebp),%eax
{
 ...
 731:	0f 84 f9 00 00 00    	je     830 <vmalloc+0x110>
  {
    // alloc huge pages
    Header *p, *prevp;
    uint nunits;
 ...
 737:	83 c6 07             	add    $0x7,%esi
    if((prevp = hugefreep) == 0){
 73a:	8b 3d 2c 0d 00 00    	mov    0xd2c,%edi
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 740:	c1 ee 03             	shr    $0x3,%esi
 743:	83 c6 01             	add    $0x1,%esi
    if((prevp = hugefreep) == 0){
 746:	85 ff                	test   %edi,%edi
 748:	0f 84 b2 00 00 00    	je     800 <vmalloc+0xe0>
 ...
 74e:	8b 17                	mov    (%edi),%edx
      if(p->s.size >= nunits){
 750:	8b 4a 04             	mov    0x4(%edx),%ecx
 753:	39 f1                	cmp    %esi,%ecx
 755:	73 67                	jae    7be <vmalloc+0x9e>
 757:	bb 00 00 08 00       	mov    $0x80000,%ebx
 75c:	39 de                	cmp    %ebx,%esi
 75e:	0f 43 de             	cmovae %esi,%ebx
  p = shugebrk(nu * sizeof(Header));
 761:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 768:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 76b:	eb 14                	jmp    781 <vmalloc+0x61>
 ...
 777:	73 4f                	jae    7c8 <vmalloc+0xa8>
          p->s.size = nunits;
        }
        hugefreep = prevp;
        return (void*)(p + 1);
      ...
      if(p == hugefreep)
 779:	8b 3d 2c 0d 00 00    	mov    0xd2c,%edi
 77f:	89 c2                	mov    %eax,%edx
 781:	39 d7                	cmp    %edx,%edi
 783:	75 eb                	jne    770 <vmalloc+0x50>
  p = shugebrk(nu * sizeof(Header));
 785:	83 ec 0c             	sub    $0xc,%esp
 788:	ff 75 e4             	push   -0x1c(%ebp)
 78b:	e8 f3 fb ff ff       	call   383 <shugebrk>
  if(p == (char*)-1)
 790:	83 c4 10             	add    $0x10,%esp
 793:	83 f8 ff             	cmp    $0xffffffff,%eax
 796:	74 1c                	je     7b4 <vmalloc+0x94>
  hp->s.size = nu;
 ...
 7a1:	50                   	push   %eax
 7a2:	e8 49 fe ff ff       	call   5f0 <vfree>
  return hugefreep;
 7a7:	8b 15 2c 0d 00 00    	mov    0xd2c,%edx
        if((p = morehugecore(nunits)) == 0)
 7ad:	83 c4 10             	add    $0x10,%esp
 7b0:	85 d2                	test   %edx,%edx
 7b2:	75 bc                	jne    770 <vmalloc+0x50>
          return 0;
    }
  }
 ...
 7d4:	89 70 04             	mov    %esi,0x4(%eax)
        hugefreep = prevp;
 7d7:	89 15 2c 0d 00 00    	mov    %edx,0xd2c
 ...
 7f4:	eb e1                	jmp    7d7 <vmalloc+0xb7>
 7f6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 7fd:	8d 76 00             	lea    0x0(%esi),%esi
      hugebase.s.ptr = hugefreep = prevp = &hugebase;
 800:	c7 05 2c 0d 00 00 30 	movl   $0xd30,0xd2c
 807:	0d 00 00 
      hugebase.s.size = 0;
 80a:	bf 30 0d 00 00       	mov    $0xd30,%edi
      hugebase.s.ptr = hugefreep = prevp = &hugebase;
 80f:	c7 05 30 0d 00 00 30 	movl   $0xd30,0xd30
 816:	0d 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
      hugebase.s.size = 0;
 81b:	c7 05 34 0d 00 00 00 	movl   $0x0,0xd34
 822:	00 00 00 
      if(p->s.size >= nunits){
 825:	e9 2d ff ff ff       	jmp    757 <vmalloc+0x37>
...
00000840 <malloc>:
{
 ...
 84c:	81 fe 40 42 0f 00    	cmp    $0xf4240,%esi
 852:	0f 87 b8 00 00 00    	ja     910 <malloc+0xd0>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 858:	83 c6 07             	add    $0x7,%esi
  if((prevp = freep) == 0){
 85b:	8b 3d 38 0d 00 00    	mov    0xd38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 861:	c1 ee 03             	shr    $0x3,%esi
 864:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
 867:	85 ff                	test   %edi,%edi
 869:	0f 84 d1 00 00 00    	je     940 <malloc+0x100>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 86f:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
 871:	8b 4a 04             	mov    0x4(%edx),%ecx
 874:	39 f1                	cmp    %esi,%ecx
 876:	73 66                	jae    8de <malloc+0x9e>
 878:	bb 00 10 00 00       	mov    $0x1000,%ebx
 87d:	39 de                	cmp    %ebx,%esi
 87f:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
 882:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 889:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 88c:	eb 13                	jmp    8a1 <malloc+0x61>
 ...
 897:	73 4f                	jae    8e8 <malloc+0xa8>
    if(p == freep)
 899:	8b 3d 38 0d 00 00    	mov    0xd38,%edi
 89f:	89 c2                	mov    %eax,%edx
 8a1:	39 d7                	cmp    %edx,%edi
 8a3:	75 eb                	jne    890 <malloc+0x50>
  p = sbrk(nu * sizeof(Header));
 8a5:	83 ec 0c             	sub    $0xc,%esp
 8a8:	ff 75 e4             	push   -0x1c(%ebp)
 8ab:	e8 ab fa ff ff       	call   35b <sbrk>
  if(p == (char*)-1)
 8b0:	83 c4 10             	add    $0x10,%esp
 8b3:	83 f8 ff             	cmp    $0xffffffff,%eax
 8b6:	74 1c                	je     8d4 <malloc+0x94>
  hp->s.size = nu;
 ...
 8c1:	50                   	push   %eax
 8c2:	e8 29 fd ff ff       	call   5f0 <vfree>
  return freep;
 8c7:	8b 15 38 0d 00 00    	mov    0xd38,%edx
      if((p = morecore(nunits)) == 0)
 8cd:	83 c4 10             	add    $0x10,%esp
 8d0:	85 d2                	test   %edx,%edx
 8d2:	75 bc                	jne    890 <malloc+0x50>
}
 ...
 8e0:	89 fa                	mov    %edi,%edx
 8e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
 8e8:	39 ce                	cmp    %ecx,%esi
 8ea:	0f 84 80 00 00 00    	je     970 <malloc+0x130>
        p->s.size -= nunits;
 8f0:	29 f1                	sub    %esi,%ecx
 8f2:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
 8f5:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
 8f8:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8fb:	89 15 38 0d 00 00    	mov    %edx,0xd38
      return (void*)(p + 1);
 ...
 90c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(nbytes > 1000000 && (getthp() != 0)){
 910:	e8 7e fa ff ff       	call   393 <getthp>
 915:	85 c0                	test   %eax,%eax
 917:	0f 84 3b ff ff ff    	je     858 <malloc+0x18>
    printf(1, "Triggered thp\n");
 91d:	83 ec 08             	sub    $0x8,%esp
 920:	68 15 0a 00 00       	push   $0xa15
 925:	6a 01                	push   $0x1
 927:	e8 24 fb ff ff       	call   450 <printf>
    return vmalloc(nbytes, VMALLOC_SIZE_HUGE);
 92c:	58                   	pop    %eax
 92d:	5a                   	pop    %edx
 92e:	6a 01                	push   $0x1
 930:	56                   	push   %esi
 931:	e8 ea fd ff ff       	call   720 <vmalloc>
 936:	83 c4 10             	add    $0x10,%esp
 939:	eb c9                	jmp    904 <malloc+0xc4>
 93b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 93f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 940:	c7 05 38 0d 00 00 3c 	movl   $0xd3c,0xd38
 947:	0d 00 00 
    base.s.size = 0;
 94a:	bf 3c 0d 00 00       	mov    $0xd3c,%edi
    base.s.ptr = freep = prevp = &base;
 94f:	c7 05 3c 0d 00 00 3c 	movl   $0xd3c,0xd3c
 956:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 959:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 95b:	c7 05 40 0d 00 00 00 	movl   $0x0,0xd40
 962:	00 00 00 
    if(p->s.size >= nunits){
 965:	e9 0e ff ff ff       	jmp    878 <malloc+0x38>
 96a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
 970:	8b 08                	mov    (%eax),%ecx
 972:	89 0a                	mov    %ecx,(%edx)
 974:	eb 85                	jmp    8fb <malloc+0xbb>
