 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 f4 09 00 00 	movzbl 0x9f4(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 9c 09 00 00 	jmp    *0x99c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 95 09 00 00       	mov    $0x995,%edx
        while(*s != 0){
...
vfree(void *ap)
{
 ...
 5f1:	a1 1c 0d 00 00       	mov    0xd1c,%eax
{
 ...
 609:	a1 10 0d 00 00       	mov    0xd10,%eax
 ...
 63b:	89 11                	mov    %edx,(%ecx)
      ...
      p->s.ptr = bp;
    hugefreep = p;
 63d:	89 0d 10 0d 00 00    	mov    %ecx,0xd10
  }
}
 643:	5b                   	pop    %ebx
 644:	5e                   	pop    %esi
 ...
 681:	5b                   	pop    %ebx
    freep = p;
 682:	89 0d 1c 0d 00 00    	mov    %ecx,0xd1c
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b0:	03 43 fc             	add    -0x4(%ebx),%eax
    hugefreep = p;
 6b3:	89 0d 10 0d 00 00    	mov    %ecx,0xd10
      p->s.size += bp->s.size;
 ...
 729:	8b 45 0c             	mov    0xc(%ebp),%eax
{
 ...
 73a:	8b 3d 10 0d 00 00    	mov    0xd10,%edi
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 777:	73 4f                	jae    7c8 <vmalloc+0xa8>
      ...
      if(p == hugefreep)
 779:	8b 3d 10 0d 00 00    	mov    0xd10,%edi
 ...
 7a2:	e8 49 fe ff ff       	call   5f0 <vfree>
  return hugefreep;
 7a7:	8b 15 10 0d 00 00    	mov    0xd10,%edx
 ...
 7d4:	89 70 04             	mov    %esi,0x4(%eax)
        hugefreep = prevp;
 7d7:	89 15 10 0d 00 00    	mov    %edx,0xd10
 ...
 7fd:	8d 76 00             	lea    0x0(%esi),%esi
      hugebase.s.ptr = hugefreep = prevp = &hugebase;
 800:	c7 05 10 0d 00 00 14 	movl   $0xd14,0xd10
 807:	0d 00 00 
      hugebase.s.size = 0;
 80a:	bf 14 0d 00 00       	mov    $0xd14,%edi
      hugebase.s.ptr = hugefreep = prevp = &hugebase;
 80f:	c7 05 14 0d 00 00 14 	movl   $0xd14,0xd14
 816:	0d 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
      hugebase.s.size = 0;
 81b:	c7 05 18 0d 00 00 00 	movl   $0x0,0xd18
 822:	00 00 00 
      if(p->s.size >= nunits){
...
00000840 <malloc>:
{
 ...
 858:	83 c6 07             	add    $0x7,%esi
  if((prevp = freep) == 0){
 85b:	8b 3d 1c 0d 00 00    	mov    0xd1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 897:	73 4f                	jae    8e8 <malloc+0xa8>
    if(p == freep)
 899:	8b 3d 1c 0d 00 00    	mov    0xd1c,%edi
 ...
 8c2:	e8 29 fd ff ff       	call   5f0 <vfree>
  return freep;
 8c7:	8b 15 1c 0d 00 00    	mov    0xd1c,%edx
 ...
 930:	c7 05 1c 0d 00 00 20 	movl   $0xd20,0xd1c
 937:	0d 00 00 
    base.s.size = 0;
 93a:	bf 20 0d 00 00       	mov    $0xd20,%edi
    base.s.ptr = freep = prevp = &base;
 93f:	c7 05 20 0d 00 00 20 	movl   $0xd20,0xd20
 946:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 949:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 94b:	c7 05 24 0d 00 00 00 	movl   $0x0,0xd24
 952:	00 00 00 
    if(p->s.size >= nunits){
