 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 e0 09 00 00 	movzbl 0x9e0(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 88 09 00 00 	jmp    *0x988(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 7f 09 00 00       	mov    $0x97f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 38 0d 00 00       	mov    0xd38,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 38 0d 00 00    	mov    %edx,0xd38
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 38 0d 00 00    	mov    %edx,0xd38
    p->s.size += bp->s.size;
...
vfree(void *ap, uint flag)
{
 ...
 671:	a1 2c 0d 00 00       	mov    0xd2c,%eax
{
 ...
 679:	8b 55 0c             	mov    0xc(%ebp),%edx
{
 ...
 6b9:	5b                   	pop    %ebx
    hugefreep = p;
 6ba:	89 15 2c 0d 00 00    	mov    %edx,0xd2c
}
 6c0:	5e                   	pop    %esi
 6c1:	5f                   	pop    %edi
 6c2:	5d                   	pop    %ebp
 ...
 6e0:	03 43 fc             	add    -0x4(%ebx),%eax
    hugefreep = p;
 6e3:	89 15 2c 0d 00 00    	mov    %edx,0xd2c
      p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 38 0d 00 00    	mov    0xd38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d 38 0d 00 00    	mov    0xd38,%edi
 ...
 7aa:	e8 31 fe ff ff       	call   5e0 <free>
  return freep;
 7af:	8b 15 38 0d 00 00    	mov    0xd38,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 38 0d 00 00    	mov    %edx,0xd38
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 38 0d 00 00 3c 	movl   $0xd3c,0xd38
 7f7:	0d 00 00 
    base.s.size = 0;
 7fa:	bf 3c 0d 00 00       	mov    $0xd3c,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 3c 0d 00 00 3c 	movl   $0xd3c,0xd3c
 806:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 40 0d 00 00 00 	movl   $0x0,0xd40
 812:	00 00 00 
    if(p->s.size >= nunits){
 ...
 839:	8b 45 0c             	mov    0xc(%ebp),%eax
{
 ...
 84a:	8b 3d 2c 0d 00 00    	mov    0xd2c,%edi
    nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 887:	73 4f                	jae    8d8 <vmalloc+0xa8>
      ...
      if(p == hugefreep)
 889:	8b 3d 2c 0d 00 00    	mov    0xd2c,%edi
 ...
 8b2:	e8 29 fd ff ff       	call   5e0 <free>
  return hugefreep;
 8b7:	8b 15 2c 0d 00 00    	mov    0xd2c,%edx
 ...
 8e4:	89 70 04             	mov    %esi,0x4(%eax)
        hugefreep = prevp;
 8e7:	89 15 2c 0d 00 00    	mov    %edx,0xd2c
 ...
 90d:	8d 76 00             	lea    0x0(%esi),%esi
      hugebase.s.ptr = hugefreep = prevp = &hugebase;
 910:	c7 05 2c 0d 00 00 30 	movl   $0xd30,0xd2c
 917:	0d 00 00 
      hugebase.s.size = 0;
 91a:	bf 30 0d 00 00       	mov    $0xd30,%edi
      hugebase.s.ptr = hugefreep = prevp = &hugebase;
 91f:	c7 05 30 0d 00 00 30 	movl   $0xd30,0xd30
 926:	0d 00 00 
    for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 929:	89 fa                	mov    %edi,%edx
      hugebase.s.size = 0;
 92b:	c7 05 34 0d 00 00 00 	movl   $0x0,0xd34
 932:	00 00 00 
      if(p->s.size >= nunits){
